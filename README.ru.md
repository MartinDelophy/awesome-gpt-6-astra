...
- **[Silent Meridian / 静默子午线](https://github.com/stackloomdev/silent-meridian)** — Атмосферное приключение с управлением мышью или касаниями: четыре главы и тринадцать головоломок. Сопоставляйте Настоящее с его Эхом, собирайте улики и раскройте тайну обсерватории, где время застыло в 00:17.
  - Автор: [stackloomdev](https://github.com/stackloomdev)
  - Платформа: Браузеры на компьютерах и мобильных устройствах; китайский и английский языки. Бесплатно, без входа и ключа API; запуск через локальный HTTP-сервер или статический хостинг. Эффекты WebGL можно отключить; без их поддержки отображаются исходные иллюстрации.
