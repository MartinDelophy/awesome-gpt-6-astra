...
- **[Astra Floor](https://astrafloor.berochlu.workers.dev/)** — Выживайте среди усиливающихся волн зомби и сразитесь с финальным боссом в 3D-шутере от первого лица с контролем отдачи, выносливостью и атаками катаной.
  - Автор: [BEROCHLU](https://github.com/BEROCHLU)
  - Платформа: Настольный браузер с WebGL, клавиатура и мышь. По словам автора, бесплатно, без входа в аккаунт и установки.
  - GPT-6 Astra: [Issue #96](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/96) — По словам автора, GPT-6 Astra помог с архитектурой, процедурной 3D-генерацией и синтезом Web Audio; Antigravity 2.0 использовался для остальной реализации и доработок.
  - Материалы: [Исходный код](https://github.com/BEROCHLU/astrafloor) · React, Three.js, TypeScript, Web Audio · [2026-09-18](assets/screenshots/astra-floor/SOURCE.md)
  - Предпросмотр: ![Скриншот автора: бой с волной зомби из винтовки.](assets/screenshots/astra-floor/gameplay.png)
...
- **[Thornwake](https://thornwake-moth-descent.ltodd.chatgpt.site/)** — Экшен-роглайт о насекомых: сражайтесь иглой, прыгайте и совершайте рывки в заросших корнями залах, собирая шёлк и тлеющие семена в повторных спусках.
  - Автор: [Lehiem / LiamTodd98](https://github.com/LiamTodd98)
  - Платформа: Браузер на компьютере; клавиатурное управление, бесплатно, без входа в аккаунт и установки. Начальный бой проверен.
  - GPT-6 Astra: [Заявка автора](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/92) — Автор сообщает, что попросил Astra создать игру в стиле Silksong, а затем доработал игровой процесс двумя дополнительными запросами. [Примечания к проверке](assets/screenshots/thornwake/SOURCE.md).
  - Предпросмотр: ![Первый зал Thornwake, The Pale Undergrowth, с врагами-насекомыми, платформами, индикаторами здоровья и шёлка и подсказками клавиатурного управления. Снимок от 2026-09-15.](assets/screenshots/thornwake/gameplay.jpg)
...
- **[Vesper: The Last Light](https://vesper.mansgullberg.chatgpt.site/)** — Исследуйте затопленные сады и небесные механизмы в приключении с загадками от третьего лица. Распределяйте свет между здоровьем, боеприпасами и валютой, чтобы восстановить три печати.
  ...
  - Платформа: Настольный браузер; клавиатура и мышь, без входа в аккаунт. Автор пока не рекомендует мобильные устройства.
  - GPT-6 Astra: [Issue #82](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/82) — Автор сообщает о 40–50 часах работы Astra в Codex с уровнями рассуждения medium/high/extra-high под руководством человека.
  - Заметки о проверке: [2026-09-15](assets/screenshots/vesper/SOURCE.md)
  - Предпросмотр: ![Vesper — The Flooded Gate](assets/screenshots/vesper/gameplay.png)
