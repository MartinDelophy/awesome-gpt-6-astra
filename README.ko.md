...
현재 **게임 및 인터랙티브 작품 90개**를 소개합니다. 삼국지 영토 전략, 나무 결합 퍼즐과 슬라이딩 퍼즐, 부드러운 과일 합치기, 절차적 도시 건설 2048, 원버튼 비행, 마법 양탄자 전투, 5개 스테이지의 탄막 슈팅, 섬의 전력망을 이용한 타워 디펜스, 야생 생존, 수중 낚시와 초밥집 경영 및 섬 농사, 베이 서킷 카트 레이싱, 펠리컨과 함께하는 해안 자전거 달리기, 탁상 장난감을 옮긴 3D 게임, 3D 집 꾸미기, 그리고 Orbital Garden을 만나 보세요. 작품명을 누르면 브라우저에서 바로 플레이할 수 있습니다.

목록 업데이트: **2026-09-18**. 모델 사용 정보는 제작자 또는 제출자의 설명을 바탕으로 하며, 미확인 내용은 각 항목에 표시합니다. 이 날짜는 목록 관리 날짜이며 모든 게임을 다시 플레이 테스트한 날짜가 아닙니다.
...
- **[Astra Floor](https://astrafloor.berochlu.workers.dev/)** — 반동 제어, 체력 관리, 카타나 공격으로 점점 강해지는 좀비 무리와 최종 보스에 맞서는 3D 1인칭 생존 슈팅 게임.
  - 제작자: [BEROCHLU](https://github.com/BEROCHLU)
  - 플랫폼: WebGL 지원 데스크톱 브라우저, 키보드와 마우스. 제작자에 따르면 무료이며 로그인이나 설치가 필요 없음.
  - GPT-6 Astra: [Issue #96](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/96) — 제작자는 GPT-6 Astra를 구조 설계, 절차적 3D 생성과 Web Audio 음향 합성에, Antigravity 2.0을 추가 구현과 개선에 사용했다고 설명함.
  - 개발 자료: [소스 코드](https://github.com/BEROCHLU/astrafloor) · React, Three.js, TypeScript, Web Audio · [2026-09-18](assets/screenshots/astra-floor/SOURCE.md)
  - 미리보기: ![제작자 제공 게임 화면: 소총으로 좀비 무리와 전투.](assets/screenshots/astra-floor/gameplay.png)
...
- **[IRON BASTION / 钢铁防线](https://iron-bastion.zecoba.workers.dev/)** — 6개 전장에서 3D 전차를 조종해 몰려오는 적으로부터 신호탑을 지킵니다. 벽돌 벽을 파괴하고 돌진과 전자기 펄스를 사용할 수 있습니다.
  - 제작자: [chat01.ai](https://linux.do/u/bandaot)
  - 플랫폼: WebGL 2 지원 브라우저, 중국어 UI. 설명서에 키보드·마우스 및 터치 조작이 안내되어 있습니다. 로그인이나 결제 없이 전투 시작을 확인했습니다.
  - GPT-6 Astra: GPT-6 Astra 사용 여부와 담당 범위는 제작자 확인을 기다리고 있습니다.
  - 미리보기: ![IRON BASTION / 钢铁防线 — 실제 게임 화면](assets/screenshots/iron-bastion/gameplay.jpg)

- **[Stick Fighter](https://stick-fighter-production.up.railway.app/)** — 펀치, 발차기, 어퍼컷, 표창, 패링을 갖춘 개발 중인 스틱맨 격투 게임입니다. 봇 연습과 온라인·친구 모드 메뉴가 있습니다.
  - 제작자: [Dwayne](https://x.com/CtrlAltDwayne)
  - 플랫폼: 데스크톱 브라우저, 키보드 조작. 봇 연습은 로그인 없이 가능합니다. 온라인 대전과 컨트롤러는 별도 검증하지 않았습니다.
...
- **[Spy or Lie](https://spyorlie.com/)** — 컴퓨터와 대결하는 육각형 전략 보드게임입니다. 정체를 숨긴 요원을 배치하고 허세와 포위로 연쇄 점령을 노립니다.
  ...
  - 플랫폼: 브라우저, 영어 UI. 로그인이나 결제 없이 첫 수와 컴퓨터의 응답을 확인했습니다.
  - GPT-6 Astra: [X](https://x.com/NateLorenzen/status/2097504974683152559) — 제작자는 Astra가 자신의 게임 설계를 한 번에 플레이 가능한 데모로 구현했다고 밝혔습니다. 개발 과정은 독립적으로 감사하지 않았습니다.
  - 미리보기: ![Spy or Lie — 실제 게임 화면](assets/screenshots/spy-or-lie/gameplay.jpg)
...
- **[Silent Meridian / 静默子午线](https://silent-meridian.stackloom.org/)** — 4개 챕터와 13개 퍼즐로 구성된 신비로운 포인트 앤 클릭 어드벤처. 현재와 메아리의 단서를 비교하고 증거를 모아 00:17에 시간이 멈춘 관측소의 비밀을 밝힌다.
  - 제작자: [stackloomdev](https://github.com/stackloomdev)
  - 플랫폼: 데스크톱 및 모바일 브라우저. 중국어와 영어 지원. 온라인에서 무료로 바로 플레이할 수 있으며 로그인, 설치 또는 API 키가 필요 없다. 선택형 WebGL 효과를 지원하지 않는 환경에서는 원본 일러스트를 표시한다.
