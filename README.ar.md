...
استكشف **87 لعبة ومشروعًا تفاعليًا**: استراتيجية السيطرة على الأراضي في عصر الممالك الثلاث، ألغاز خشبية متشابكة وألغاز الكتل المنزلقة، دمج الفواكه المرنة، ولعبة 2048 لبناء المدن بالتوليد الإجرائي، والطيران بزر واحد، والقتال على بساط سحري، ولعبة تصويب كثيفة الرصاص من خمس مراحل، والدفاع عن جزيرة بشبكة كهربائية، والبقاء في البرية، وصيد الأسماك تحت الماء وإدارة مطعم سوشي والزراعة على جزيرة، وسباقات الكارت على حلبة الخليج، وركوب الدراجة مع بجع على الساحل، وألعاب طاولة محوّلة إلى ألعاب ثلاثية الأبعاد، وتصميم ديكور المنازل ثلاثي الأبعاد، وOrbital Garden. انقر على اسم العمل لفتح اللعبة مباشرة في المتصفح.

تحديث القائمة: **2026-09-14**. تستند معلومات استخدام النموذج إلى تصريحات المؤلفين أو مقدّمي الأعمال؛ وتُوضّح التفاصيل غير المؤكدة في كل بند. يشير هذا التاريخ إلى تحديث القائمة، وليس إلى إعادة اختبار جميع الألعاب.
...
- **[Stick Fighter](https://stick-fighter-production.up.railway.app/)** — لعبة قتال بشخصيات عصوية قيد التطوير، تشمل اللكم والركل والضربات الصاعدة ونجوم النينجا والصد؛ تتوفر تدريبات ضد بوت وقوائم للعب عبر الإنترنت ومع الأصدقاء.
  - المؤلف: [Dwayne](https://x.com/CtrlAltDwayne)
  - المنصة: متصفح سطح المكتب ولوحة مفاتيح؛ التدريب متاح دون تسجيل الدخول. لم يُختبر اللعب الجماعي عبر الإنترنت أو ذراع التحكم بصورة مستقلة.
...
- **[Mystery Town](https://playableworld.itch.io/mystery-town)** — راقب عوالم ثلاثية الأبعاد مصغرة، وافحص الأشياء وحركها، وحل الألغاز البيئية باكتشاف التسلسل السببي الصحيح.
  - المؤلف: [PlayableWorld](https://playableworld.itch.io/)
  - المنصة: المتصفح؛ مجاني، يتطلب WebGL. فأرة أو لمس؛ تم التحقق على الحاسوب. الشفرة المصدرية غير منشورة.
  - GPT-6 Astra: [Issue #80](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/80) — وفقًا للمشاركة، كان Astra وكيل التطوير الرئيسي لأسلوب اللعب والمشاهد والأصول ثلاثية الأبعاد والاختبار والتحسين، بتوجيه ومراجعة بشرية.
  - ملاحظات التحقق: [TypeScript · Vite · Three.js · Blender](assets/screenshots/mystery-town/SOURCE.md)
  - معاينة: ![Mystery Town — The Borrowed Light Study](assets/screenshots/mystery-town/gameplay.png)
...
- **[Tidehook](https://tidehook-mallow.vercel.app/)** — قُد القاطرة الصغيرة Mallow في ثلاث رحلات ساحلية، واسحب لقى بحرية يؤثر وزنها في التسارع والانعطاف، وسلّمها لرافعة المرفأ وصولًا إلى استعادة عدسة منارة.
  - المطوّر: [Emile du Toit / Mafuta Games](https://mafuta.itch.io/)
  - المنصة: متصفح على حاسوب مكتبي أو محمول، بواجهة إنجليزية؛ مجانًا، دون تسجيل دخول أو تثبيت. التحكم بلوحة المفاتيح أو بالنقر على الماء، مع حفظ التقدم في المتصفح الحالي. لم يُتحقق من اللعب على هاتف فعلي.
  - GPT-6 Astra: [تصريح المطوّر](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/74) — استخدم المطوّر GPT-6 Astra داخل Codex لتطوير لعبة Canvas وفيزياء السحب وتسليم الحمولة للرافعة والواجهة والطقس والصوت وتحسينها على عدة مراحل، مع توليه توجيه التصميم وتجربة اللعبة. أُنتجت الرسومات منفصلةً بواسطة توليد الصور، وتُركَّب الموسيقى والمؤثرات الصوتية باستخدام Web Audio.
  - الموارد: [itch.io](https://mafuta.itch.io/tidehook) · [فيديو أسلوب اللعب](https://youtu.be/wlEh8gnDOnU) · JavaScript دون إطار عمل وCanvas 2D وVite وWeb Audio؛ مستودع الكود المصدري خاص. [التحقق ومصدر لقطة الشاشة (بالإنجليزية)](assets/screenshots/tidehook/SOURCE.md)
  - معاينة: ![لقطة قدّمها المطوّر من إصدار 2026-09-11: تسحب Mallow حمولة ثقيلة بين جزر The Old Sound، مع عرض المسافة إلى المرفأ والخريطة المصغرة.](assets/screenshots/tidehook/gameplay.png)
...
- **[Spy or Lie](https://spyorlie.com/)** — لعبة استراتيجية على لوحة سداسية ضد الكمبيوتر: ضع عملاء بهويات مخفية وخادع خصمك وحاصر مجموعاته لتنفيذ سلسلة من الاستحواذات.
  ...
  - المنصة: متصفح بواجهة إنجليزية؛ تم التحقق من الحركة الأولى ورد الكمبيوتر دون تسجيل الدخول أو الدفع.
  - GPT-6 Astra: [X](https://x.com/NateLorenzen/status/2097504974683152559) — يقول المؤلف إن Astra حوّل تصميمه إلى نسخة قابلة للعب بمحاولة واحدة؛ لم تُدقق عملية التطوير بصورة مستقلة.
  - معاينة: ![Spy or Lie — لقطة من اللعبة](assets/screenshots/spy-or-lie/gameplay.jpg)
...
- **[潜水员戴夫 / Dave the Diver](https://dave-2cm.pages.dev/)** — إعادة إنشاء للعبة Dave the Diver تعمل في المتصفح، وتجمع بين صيد الأسماك بالحربة تحت الماء وإدارة مطعم سوشي والزراعة على جزيرة.
  - المبدع: dudu
  - المنصة: المتصفح؛ واجهة صينية وتحكم بالفأرة ولوحة المفاتيح. جرى التحقق من إمكانية الدخول وبدء الغوص دون تسجيل دخول أو دفع.
  - GPT-6 Astra: [تصريح مقدّم الطلب](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/41) — ينسب مقدّم الطلب عملية التطوير كاملةً إلى GPT-6 Astra.
  - موارد التطوير: لم تُقدّم شفرة مصدرية عامة أو سجل تطوير منفصل.
...
- **[Barrelbound: The Lost Cargo](https://barrelbound.vercel.app/)** — اختر Rocco أو Pip لخوض ثلاث مراحل منصات في الغابة: اقفز قفزة مزدوجة، وارمِ البراميل، واركب عربة المنجم لاستعادة الحمولة المفقودة والوصول إلى الزعيم الأخير.
  - المطوّر: [Emile du Toit / Mafuta Games](https://mafuta.itch.io/)
  - المنصة: متصفح على حاسوب مكتبي أو محمول، بواجهة إنجليزية؛ مجانًا، دون تسجيل دخول أو تثبيت. التحكم بلوحة المفاتيح؛ دعم يد التحكم بحسب تصريح المطوّر.
  - GPT-6 Astra: [تصريح المطوّر](https://github.com/MartinDelophy/awesome-gpt-6-astra/issues/73) — استخدم المطوّر GPT-6 Astra داخل Codex لكتابة الكود وآليات اللعب والتحسين المتكرر والاختبار، مع توليه توجيه التصميم وتجربة اللعبة بنفسه. أُنتجت الرسومات منفصلةً بواسطة توليد الصور، وتُركَّب الموسيقى والمؤثرات الصوتية باستخدام Web Audio.
  - الموارد: [itch.io](https://mafuta.itch.io/barrelbound) · [فيديو أسلوب اللعب](https://youtu.be/X87UqF_n3ro) · Phaser 3 وVite وWeb Audio؛ مستودع الكود المصدري خاص. [التحقق ومصدر لقطة الشاشة (بالإنجليزية)](assets/screenshots/barrelbound/SOURCE.md)
  - معاينة: ![لقطة قدّمها المطوّر من إصدار سبتمبر 2026: Rocco والبراميل ومسارات الموز على المنصات الخشبية في Jungle Dock Dash.](assets/screenshots/barrelbound/gameplay.jpg)
...
| الوصول | رابط مباشر للعب في المتصفح دون تنزيل أو تثبيت أو إعداد محلي أو تسجيل دخول |
